...
export default async function LandscaperLogin({ searchParams }) {
    ...
    <main className="flex flex-1 flex-col items-center justify-center bg-zinc-50 px-6 py-24">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-1 text-center text-sm text-black">
          Just want to be listed without a login?{" "}
          <Link href="/landscapers" className="font-medium text-green-700">
            Use the quick signup form
          </Link>
        </p>
      </div>
    </main>
