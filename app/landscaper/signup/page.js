...
export default async function LandscaperSignup({ searchParams }) {
    ...
    <main className="flex flex-1 flex-col items-center justify-center bg-zinc-50 px-6 py-24">
      <div className="w-full max-w-sm">
        <h1 className="text-center text-2xl font-bold text-black">
          Create Your Landscaper Account
        </h1>
        <p className="mt-2 text-center text-sm text-black">
          Manage your profile and respond to client requests from one
          dashboard.
        </p>
